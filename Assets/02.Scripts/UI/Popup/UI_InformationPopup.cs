...
public class UI_InformationPopup : UI_Popup
{
    ...
    public void OnClickPasswordChange()
    {
        ...
        messagePopup.Init("パスワード変更メールを送信しました。", false);
    }
    ...
    public void OnClickChangeNickname()
    {
        ...
        messagePopup.Init($"ニックネームを変更しますか？ ({NicknameChangeCost} ダイヤパウダー消費).", true, OnSetNickname);
    }
    ...
    public void OnClickMyInfo()
    {
        ...
        messagePopup.Init("マイ情報機能は現在サポートされていません。", false);
    }
    ...
    public async void OnSetNickname()
    {
        ...
        if (result.IsSuccess == true)
        {
            ...
            messagePopup.Init("ニックネームを変更しました。", false);
            Refresh();
        }
        else
        {
            ...
            messagePopup.Init($"ニックネームの変更に失敗しました。: {result.Message}", false);
            return;
        }
