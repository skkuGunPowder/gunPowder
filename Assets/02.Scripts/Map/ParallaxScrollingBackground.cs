...
public sealed class ParallaxScrollingBackground : MonoBehaviour
{
	...
	[SerializeField] private Transform background_leftPoint, background_rightPoint;
	[SerializeField] Transform ground_leftPoint, ground_rightPoint;
	[SerializeField] Transform camera_leftPoint, camera_rightPoint;

	float ground_sideSpace = 0f;
	float background_sideSpace = 0f;
